...
struct SceneKitView: UIViewRepresentable {
    ...
    private extension SceneKitView {
        func createSceneView(context: Context) -> SCNView {
        ...
        func setupGestureRecognizers(_ sceneView: SCNView, context: Context) {
        ...
        func removeNodes(from uiView: SCNView, matching names: [String]) {
        ...
        func setupCamera(in uiView: SCNView) {
        ...
        func createAtomsAndConnections(uiView: SCNView, atoms: [Atom], connects: [Connect]) {
            for atom in atoms {
